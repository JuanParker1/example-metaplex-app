...
import type { AuctionViewItem } from '@oyster/common/dist/lib/models/metaplex/index';
...
import type { AuctionView as Auction } from '../../hooks';
...
const BidLine = (properties: {
  ...
  const { bid, mint, isCancelled, mintKey } = properties;
...
export const AuctionBids = ({
  ...
  if (!auctionView || bids.length === 0) return null;
