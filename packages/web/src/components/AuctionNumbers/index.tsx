...
import type { CountdownState } from '@oyster/common';
import {
  formatTokenAmount,
  useMint,
  fromLamports,
...
import { AuctionViewState, useBidsForAuction } from '../../hooks';
import { AmountLabel } from '../AmountLabel';
import { useAuctionCountdown } from '../../hooks/useAuctionCountdown';
import { useTokenList } from '../../contexts/tokenList';

export const AuctionCountdown = (properties: {
...
export const AuctionNumbers = (properties: {
  auctionView: AuctionView;
  ...
  return (
    <div style={{ maxWidth: 350 }}>
        ...
        <>
          {(isUpcoming || bids.length === 0 || auctionView.isInstantSale) && (
            <AmountLabel
              ...
              style={{ marginBottom: properties.showAsRow ? 0 : 10 }}
          ...
          {!auctionView.isInstantSale && isStarted && bids.length > 0 && (
            <AmountLabel
              ...
              style={{ marginBottom: properties.showAsRow ? 0 : 10 }}
              containerStyle={{
                flexDirection: properties.showAsRow ? ' row' : 'column',
              }}
              title="Highest bid"
              tokenInfo={tokenInfo}
      ...
      {!ended && !properties.hideCountdown ? (
